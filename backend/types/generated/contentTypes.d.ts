...
export interface ApiAspiranteAspirante extends Struct.CollectionTypeSchema {
  collectionName: 'aspirantes';
  info: {
    displayName: 'aspirante';
    pluralName: 'aspirantes';
    singularName: 'aspirante';
  };
  options: {
  ...
  attributes: {
    ...
    como_se_entero: Schema.Attribute.Relation<
      'oneToOne',
      'api::enteraste.enteraste'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBachilleratoBachillerato
  extends Struct.CollectionTypeSchema {
  collectionName: 'bachilleratoes';
  info: {
    displayName: 'bachillerato';
    pluralName: 'bachilleratoes';
    singularName: 'bachillerato';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiDocumentoDocumento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    archivo: Schema.Attribute.Media<'files' | 'images' | 'videos'>;
    aspirante: Schema.Attribute.Relation<
      'manyToOne',
      'api::aspirante.aspirante'
    >;
...
export interface ApiEnterasteEnteraste extends Struct.CollectionTypeSchema {
  collectionName: 'enterastes';
  info: {
    displayName: 'enteraste';
    pluralName: 'enterastes';
    singularName: 'enteraste';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPlantillaMsgPlantillaMsg
  extends Struct.CollectionTypeSchema {
  collectionName: 'plantilla_msgs';
  info: {
    displayName: 'plantilla_msg';
    pluralName: 'plantilla-msgs';
    singularName: 'plantilla-msg';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    creado_por: Schema.Attribute.Relation<
      'oneToOne',
      'plugin::users-permissions.user'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::plantilla-msg.plantilla-msg'
    > &
      Schema.Attribute.Private;
...
export interface ApiSemaforoSemaforo extends Struct.CollectionTypeSchema {
  collectionName: 'semaforos';
  info: {
    displayName: 'semaforo';
    pluralName: 'semaforos';
    singularName: 'semaforo';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    es_final: Schema.Attribute.Boolean;
    estado_nota: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::semaforo.semaforo'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rgb: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiToqueToque extends Struct.CollectionTypeSchema {
  collectionName: 'toques';
  info: {
    displayName: 'toque';
    pluralName: 'toques';
    singularName: 'toque';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::toque.toque'> &
      Schema.Attribute.Private;
    nombre: Schema.Attribute.String;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    plantilla_msg: Schema.Attribute.Relation<
      'oneToOne',
      'api::plantilla-msg.plantilla-msg'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::aspirante.aspirante': ApiAspiranteAspirante;
      'api::bachillerato.bachillerato': ApiBachilleratoBachillerato;
      'api::campus.campus': ApiCampusCampus;
      'api::carrera.carrera': ApiCarreraCarrera;
      'api::documento.documento': ApiDocumentoDocumento;
      'api::enteraste.enteraste': ApiEnterasteEnteraste;
      'api::municipio.municipio': ApiMunicipioMunicipio;
      'api::plantilla-msg.plantilla-msg': ApiPlantillaMsgPlantillaMsg;
      'api::semaforo.semaforo': ApiSemaforoSemaforo;
      'api::toque.toque': ApiToqueToque;
